...
?>
				...
				<form action="../php/AdmitCourseCheck.php" method="post" onsubmit="return check()" enctype="multipart/form-data">
				<center>
				
				<fieldset>
				
				<legend><b>Admit Teacher Courses</b></legend>
		 ...
		 <?php } ?>
				...
				<td><input type="submit" name="submit27"  value="Admit Course"></td>
